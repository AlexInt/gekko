...
const Navbar = ({ onOpenSidebar }: NavbarProps) => {
  ...
  return (
    <div className="flex items-center p-3 sm:p-4 w-full justify-between bg-transparent h-16 z-40">
      {onOpenSidebar ? (
        <button
          type="button"
          onClick={onOpenSidebar}
          className="md:hidden inline-flex items-center justify-center h-10 w-10 rounded-full hover:bg-accent transition text-muted-foreground hover:text-foreground"
      ...
      <div className="flex items-center gap-x-4">
        <div className="glass px-3 sm:px-4 py-2 rounded-full flex items-center gap-x-3 sm:gap-x-4">
